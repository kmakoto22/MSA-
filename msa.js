...
function hideTxt() {
	openWin("<html><head></head><body><textarea rows=\"30\" cols=\"50\">Paste in text to be hidden</textarea><br><br><button onclick=\"x();\">Get Code</button><script>function x() { alert(1); }</script></body></html>");
