...
function hideTxt() {
	openWin("<textarea rows=\"30\" cols=\"50\">Paste in text to be hidden</textarea><br><br><button onclick=\"x();\">Get Code</button><script>window.error = function (e) { alert(e); } function x() { document.body.innerHTML = document.getElementsByTagName('textarea')[0].value.replace(\"\n\", \"<br>\"); }</script>");
