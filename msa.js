...
function hideTxt() {
	openWin('<html><head></head><body><textarea rows=\"30\" cols=\"50\" id=\"w\">Paste in text to be hidden</textarea><br><br><button onclick=\"x();\">Get Code</button><script>function nl2br(r,n){return null==r?"":(r+"").replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1"+(n||void 0===n?"<br />":"<br>")+"$2")} function x() { document.body.innerHTML = nl2br(document.getElementById(\"w\").value); }</script></body></html>');
