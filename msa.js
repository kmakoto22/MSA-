...
function hideTxt() {
	openWin("<textarea>Paste in text to be hidden</textarea><button onclick=\"x();\">Get Code</button><script>function x() { document.body.innerHTML = document.getElementsByTagName('textarea')[0].value.replace(\"\n\", \"<br>\"); }</script>");
