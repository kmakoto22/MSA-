...
function hideTxt() {
	openWin("<html><head></head><body><textarea rows=\"30\" cols=\"50\" id=\"w\">Paste in text to be hidden</textarea><br><br><button onclick=\"x();\">Get Code</button><script>function x() { alert(document.getElementById(\"w\").value.replace(\"\n\", \"<br>\")); }</script></body></html>");
