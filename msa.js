...
function hideTxt() {
	openWin("<html><head></head><body><textarea rows=\"30\" cols=\"50\" id=\"w\">Paste in text to be hidden</textarea><br><br><button onclick=\"alert(document.getElementById('w').value);\">Get Code</button></body></html>");
